...
function App() {
  ...
  const removeElem = (removeArticle) => {
    const secondArray = activeArticles.filter(
      (curItem) => curItem.id !== removeArticle.id
    );
    ...
    <>
      <div className="container">
        ...
        <form action="" onSubmit={handleArticlesForm}>
          ...
          {/*Published*/}
          <div className="mb-3">
            <label htmlFor="published" className="text-secondary fw-bold me-2">
              Published
            </label>
            <input
              id="published"
